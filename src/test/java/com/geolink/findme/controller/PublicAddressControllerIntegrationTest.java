...
/**
 * Tests d'intégration Web et Sécurité du contrôleur {@link PublicAddressController}.
 * Vérifie la possibilité de consulter une adresse par son addressCode sans être authentifié.
 */
@SpringBootTest
...
@DisplayName("Tests d'intégration Web REST - PublicAddressController")
class PublicAddressControllerIntegrationTest {
    ...
    void createPublicAddress_Success() throws Exception {
        ...
        mockMvc.perform(org.springframework.test.web.servlet.request.MockMvcRequestBuilders.post("/api/public/addresses")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(jsonPayload))
